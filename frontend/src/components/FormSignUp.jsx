...
const handleChange = (e) => {
  ...
  useEffect(() => {
    const { password, confirmPassword, fullName, lastName, email } = formData;
    ...
    // Form validation
    const valid = fullName && lastName && email && password && confirmPassword && password === confirmPassword;
  ...
  return (
    <div>
      ...
      <form className="container">
        ...
        {['fullName', 'lastName', 'email'].map((field, idx) => (
          <div className="form__group field" key={idx}>
            ...
            <label htmlFor={field} className="form__label">
              {field === 'fullName' ? 'Nombre completo' : field === 'lastName' ? 'Apellido' : 'Correo electrónico'}
            </label>
          </div>
        ))}
